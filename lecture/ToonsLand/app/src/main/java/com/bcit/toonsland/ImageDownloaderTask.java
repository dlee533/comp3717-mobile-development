...
/**
 * I think the reason we use a separate AsyncTask and HttpURLConnection for the images
 * is so to speed up the download of images. By running 1)download texts and 2) images
 * simultaneously, we can populate the the list of Toons at faster rate, populating the
 * recycler would be quicker as a consequence.
 */
